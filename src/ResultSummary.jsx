...
const ResultSummary = () => {
  ...
  return (
    <div className="flex items-center justify-center mt-10 mx-auto bg-white shadow-2xl overflow-hidden rounded-3xl w-fit">
      {/* left column */}
      <div className="bg-blue-600 flex flex-col items-center justify-center pt-5 rounded-3xl text-white">
        <h3 className=" opacity-70 text-center text-2xl font-medium">
          Your Result
        </h3>
        <div
          className="flex flex-col items-center justify-center text-center w-40 h-40 rounded-full bg-gradient-to-b from-blue-800/70 
            to-blue-600/10 mx-auto mt-10 mb-10"
        >
